        ...
        "/playmate/reward/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "奖励订单更新信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateRewardOrderRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.RewardOrder": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "available, grabbed, completed, cancelled",
                    "type": "string"
                },
                "tags": {
                    "description": "用逗号分隔的标签",
        ...
        "request.UpdateRewardOrderRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
